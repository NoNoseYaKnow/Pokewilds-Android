...
public final class RuntimeOptions {
    ...
    public static final int[] VIEWPORT_WIDTHS = {480, 640, 960};
    public static final int[] VIEWPORT_HEIGHTS = {432, 576, 864};
    ...
    private RuntimeOptions(String graphics, int width, int height) {
    ...
    public static RuntimeOptions read(Context context) {
        ...
        return new RuntimeOptions(graphics, width, height);
    }
